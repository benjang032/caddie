...
Make a working checklist from these steps before reasoning. Use the host's task or todo list when available. A skipped step stays listed with its reason. Do not drop it.
